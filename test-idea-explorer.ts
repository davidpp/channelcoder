...
async function addTestIdeas() {
  ...
  const ideas = [
    { title: "OAuth-Integration", description: "Add GitHub and Google OAuth support to the application" },
    { title: "Dark-Mode", description: "Implement theme switching with CSS variables and user preference persistence" },
    { title: "Real-time-Updates", description: "Add WebSocket support for live notifications and data updates" },
    { title: "API-Rate-Limiting", description: "Implement rate limiting with Redis to prevent API abuse" },
    { title: "Search-Feature", description: "Add full-text search using PostgreSQL or Elasticsearch" },
  ];

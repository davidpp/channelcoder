...
describe('Worktree E2E Tests', () => {
  ...
  it('should create and use a worktree with standalone function', async () => {
    ...
    try {
      ...
      const result = await worktree('feature/test-branch', async (wt) => {
  ...
  it('should handle worktree creation with base branch', async () => {
    ...
    try {
      const result = await worktree('feature/new-feature', async (wt) => {
  ...
  it('should handle errors gracefully', async () => {
    ...
    try {
      ...
      await expect(
        worktreeUtils.create('non-existent-branch')
  ...
  it('should compose worktree with other options in dry-run mode', async () => {
    ...
    try {
      await worktree('feature/test-branch', async (wt) => {
  ...
  it('should handle current worktree detection', async () => {
    ...
    try {
      ...
      await worktree('feature/new-detection', async (wt) => {
